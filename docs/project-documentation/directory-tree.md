...
| `docs/project-documentation/` | Deep project map generated for onboarding and token-cost reduction. It documents structure, architecture, code patterns, tool modules, config/security, testing, and agent workflow. | Edit whenever project architecture or coding patterns change. Agents should read this before broad code exploration. |
